...
export default function CHistoryAll() {
  ...
  return (
    <div >
      <Navbar title=" User History" />
      <div className="col-md-8 offset-md-2 mt-5">
        <h3 className="text-info text-center mb-4">User History</h3>
          ...
          <Table className={classes.table} size="small" aria-label="a dense table">
            <TableHead>
              <TableRow>
                ...
                <TableCell align="right">Update Payment Status</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
